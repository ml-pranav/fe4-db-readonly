...
1. Clone the monorepo anywhere.
2. Enter this project folder and run:

```powershell
cd path\to\repo\fe4-oracle-readonly
...
This project lives under the monorepo root (sibling to `fe4-sqlserver-readonly/`). Do not commit `runtime/`, `secrets.local`, or `.venv/`.
